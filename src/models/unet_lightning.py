...
class UNet_Lightning(pl.LightningModule):
    def __init__(self, UNet_params: dict, params: dict,
        ...
        self.dropout_rate = params['dropout_rate']
            # up_mode = 'resizeconv_nearest',
            # attention = True,
            # activation  = 'rrelu',

        self.model = Base_UNET3D(in_channels=self.in_channels, start_filts =  self.start_filts, dropout_rate = self.dropout_rate)

        # self.model = Base_UNET3D(in_channels=self.in_channels, start_filts =  self.start_filts, dropout_rate = self.dropout_rate, up_mode = 'resizeconv_nearest',
        #     attention = False,
        #     activation  = 'rrelu')
